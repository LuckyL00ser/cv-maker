...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 text-gray-900">
      <header className="h-16 px-4 lg:px-6 bg-white border-b border-gray-200 flex items-center justify-between shadow-sm z-20">
        ...
        <div className="flex items-center gap-2 lg:gap-4">
            <button
                ...
                className="px-3 lg:px-4 py-2 bg-orange-600 text-white rounded-lg font-medium hover:bg-orange-700 transition-colors flex items-center gap-2 shadow-sm text-sm"
            >
                <span className="hidden sm:inline">Download </span>JSON
            </button>
            <button
                onClick={() => handlePrint()}
                className="px-3 lg:px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center gap-2 shadow-sm text-sm"
            >
